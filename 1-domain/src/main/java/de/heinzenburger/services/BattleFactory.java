...
public class BattleFactory {
    ...
    public Battle createBattle(Player player, Animal opponent) throws InsufficientAnimalsException {
        ...
        if (opponent == null) throw new IllegalArgumentException("Opponent cannot be null");

        List<Animal> selectedAnimals = player.getInventory().selectRandomForBattle(BATTLE_INVENTORY_SIZE);
