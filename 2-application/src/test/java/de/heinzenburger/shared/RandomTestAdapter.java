 ...
 */
public final class RandomTestAdapter implements RandomNumberGenerator {
    private final Random random;

    public RandomTestAdapter() {
        this(new Random());
    }

    public RandomTestAdapter(Random random) {
        if (random == null) {
     ...
     */
    public RandomTestAdapter(long seed) {
